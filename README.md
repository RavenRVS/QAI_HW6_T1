...
## Задание: Статистика (обязательное к выполнению) <a href="https://github.com/RavenRVS/QAI_HW6_T1/blob/master/src/test/java/ru/netology/stats/task1/services/StatsServiceTest.java">(моё решение)</a>
